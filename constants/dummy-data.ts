...
export const timeLogData = [
  ...
  },
  {
    id: '2',
    date: '22/10/2024',
    effectiveHours: '6h 45m',
    grossHours: '6h 45m',
    arrival: 'Ontime',
    overTime: '6h 45m',
    gps: 'view',
    log: 'clock',
    attendanceVisual: 6.75,
    isWeeklyOff: false,
  },
  {
    id: '3',
    date: '05/11/2024',
    effectiveHours: '5h 30m',
    grossHours: '5h 30m',
    arrival: '0:43:20 late',
    overTime: '5h 30m',
    gps: 'view',
    log: 'clock',
    attendanceVisual: 5.5,
    isWeeklyOff: false,
  },
  {
    id: '4',
  ...
  },
  {
    ...
    arrival: 'Full day Weekly-off',
    overTime: 'Full day Weekly-off',
    gps: 'Full day Weekly-off',
    log: 'Full day Weekly-off',
    attendanceVisual: 0,
    isWeeklyOff: true,
  },
  {
  ...
  },
  {
    id: '8',
    date: '14/04/2025',
    effectiveHours: '2h 30m',
    grossHours: '2h 30m',
    arrival: 'On time',
    overTime: '2h 30m',
    gps: null,
    log: 'success',
    attendanceVisual: 2.5,
    isWeeklyOff: false,
  },
  {
    id: '9',
    date: '28/05/2025',
    effectiveHours: '10h 15m',
    grossHours: '10h 15m',
    arrival: 'On time',
    overTime: '10h 15m',
    gps: 'view',
    log: 'success',
    attendanceVisual: 10.25,
    isWeeklyOff: false,
  },
];
...
export const leaveData = [
  ...
  {
    id: '1',
    leaveDate: '16/03/2025 - 18/03/2025',
    leaveType: 'Paid Leave',
    status: 'Pending',
    actionOn: '-',
    leaveNote: 'Due to personal reason I have to go out of town',
    rejectNote: '-',
    action: 'more',
  },
];
...
export const leaveHistoryData = [
  {
    id: '1',
    leaveDates: '16/03/2025 - 18/03/2025',
    leaveType: 'Paid Leave',
    leaveNote: 'Due to personal reason I have to go out of town',
    actionOn: '15/10/2023',
    status: 'Rejected',
    note: 'Due to delivery of product',
    actionBy: 'James Anderson',
  },
  {
    id: '2',
    leaveDates: '01/05/2025 - 03/05/2025',
    leaveType: 'Unpaid Leave',
    leaveNote: 'Due to personal reason I have to go out of town',
    actionOn: '16/10/2023',
    status: 'Approved',
    note: 'As a result of the product shipment.',
    actionBy: 'James Anderson',
  },
  {
    id: '3',
    leaveDates: '10/07/2025 - 12/07/2025',
    leaveType: 'Paid Leave',
    leaveNote: 'Due to personal reason I have to go out of town',
    actionOn: '17/10/2023',
    status: 'Approved',
    note: 'Owing to the delivery of items.',
    actionBy: 'James Anderson',
  },
  {
    id: '4',
    leaveDates: '22/09/2025 - 24/09/2025',
    leaveType: 'Unpaid Leave',
    leaveNote: 'Due to personal reason I have to go out of town',
    actionOn: '18/10/2023',
    status: 'Approved',
    note: 'Because of the shipment of goods.',
    actionBy: 'James Anderson',
  },
];
