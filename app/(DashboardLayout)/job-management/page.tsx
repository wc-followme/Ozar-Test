    ...
    <div className=''>
      ...
      <div>
        ...
        >
          ...
          <TabsContent
            value={NEW_LEADS_TAB}
            className='pt-4 sm:pt-8 max-h-[calc(100vh_-_298px)] overflow-auto'
          >
