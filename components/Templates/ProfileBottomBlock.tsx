...
const PROFILE_TAB_ITEMS = [
  {
    value: PROFILE_TABS.PROFILE_INFO,
    label: 'About',
    className: 'mt-6',
  },
  {
    value: PROFILE_TABS.REVIEW,
    label: 'Review',
    className: 'mt-6',
  },
  {
    value: PROFILE_TABS.PORTFOLIO,
    label: 'Portfolio',
    className: 'mt-6',
  },
] as const;

const COMPONENTS = [ProfileInfoTab, ReviewTab, PortfolioTab] as const;

const TAB_ITEMS = PROFILE_TAB_ITEMS.map((item, index) => ({
  ...item,
