...
export default forwardRef<{ toggleEditMode: () => void }, EstimationBoxProps>(
  function EstimationBox(props, ref) {
    ...
    // Expose toggleSelectionMode method to parent component
                  ...
                  <>
                    <button
                      onClick={() => {
                        ...
                        setCheckedItems(new Set()); // Clear all selections
                      }}
